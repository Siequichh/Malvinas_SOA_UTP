...
export class DispatchService {
  ...
  getDispatches() { return this.http.get<any[]>(`${this.apiUrl}/dispatches`); }
  getActiveDispatches() { return this.http.get<any[]>(`${this.apiUrl}/dispatches/active`); }
  createDispatch(data: any) { return this.http.post<any>(`${this.apiUrl}/dispatches`, data); }
